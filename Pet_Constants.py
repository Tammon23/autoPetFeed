...
pet_homepage = { # image location, slot location
    "Silverfish": ("assets/clay_ball.png", 9),
    "Cat": ("assets/fish_cod_raw.png", 10),
    "Chicken": ("assets/egg.png", 11),
    "Wolf": ("assets/bone.png", 12),
    "Bat": ("assets/coal.png", 13),
    "Rabbit": ("assets/carrot.png", 14),
    "Villager": ("assets/emerald.png", 15),
    "Zombie": ("assets/rotten_flesh.png", 16),
    "Little_Helper": ("assets/little_helper.png", 17),
    "Golem": ("", 18),
    "Enderman": ("assets/ender_pearl.png", 19),
    "Blaze": ("", 20),
    "Snowman": ("assets/snowball.png", 21),
    "Herobrine": ("", 22),
    "Endermite": ("assets/ender_eye.png", 23),
    "Mini_Wither": ("", 24),
    "Clone": ("", 25),
    "Minecart": ("", 26),
    "Grinch": ("", 27),
    "Spider": ("assets/string.png", 28),
    "Cow": ("assets/beef_raw.png", 29),
    "Creeper": ("assets/gunpowder.png", 30),
    "Horse": ("assets/saddle.png", 31),
    "Pig": ("assets/porkchop_raw.png", 32),
    "Sheep": ("assets/mutton_raw.png", 33),
    "Slime": ("assets/slimeball.png", 34),
    "Skeleton": ("assets/bow_standby.png", 35),
    "Squid": ("", 1000)
}
